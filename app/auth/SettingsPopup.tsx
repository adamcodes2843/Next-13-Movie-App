...
const SettingsPopup = ({settings, name, displayName, favoriteMovie, favoritePizza, id, dbDarkMode}:SettingsPopupInterface) => {
  ...
  async function updateAllowComments(id:string, data:boolean) {
    try{
      await fetch(`https://pizza-night-highlights.vercel.app/api/allowCommentsSwitch/${id}`, {
        body: JSON.stringify(data),
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async function updateDisplayName(id:string, data:string) {
    try{
      await fetch(`https://pizza-night-highlights.vercel.app/api/changeDisplayName/${id}`, {
        body: JSON.stringify(data),
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async function updateFavoriteMovie(id:string, data:string) {
    try{
      await fetch(`https://pizza-night-highlights.vercel.app/api/changeFavoriteMovie/${id}`, {
        body: JSON.stringify(data),
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async function updateFavoritePizza(id:string, data:string) {
    try{
      await fetch(`https://pizza-night-highlights.vercel.app/api/changeFavoritePizza/${id}`, {
        body: JSON.stringify(data),
        headers: {
          'Content-Type': 'application/json'
        },
