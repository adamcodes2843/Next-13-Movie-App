...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col items-center">
        {/* User */}
        <section className="w-full mb-4 rounded flex flex-col items-center justify-center mt-8 py-4 gap-2 bg-gradient-to-t from-green-900">
            ...
            <h1 className="text-4xl my-1 bg-black bg-opacity-70 rounded-xl py-2 hover:shadow-gray-600 w-3/4 text-center">Username</h1>
        ...
        {/* Stats */}
        <section className="w-full gap-2 mb-4">
        ...
        {/* Pizza Night XP*/}
        <section className="w-full gap-2 mt-4">
