/*
  ...
  - You are about to drop the column `filter` on the `Settings` table. All the data in the column will be lost.
  - You are about to drop the column `sort` on the `Settings` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Settings" DROP COLUMN "filter",
DROP COLUMN "sort",
